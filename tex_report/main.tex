...
\author{
  姚宗骏 / 25110980027 / 花卉分类实验、整体代码组织与报告整合\\
  付思维 / 25210980037 / 车辆检测跟踪、视频处理与越线计数分析\\
  姜涵霖 / 25110980011 / U-Net 语义分割实验、损失函数比较与结果分析
}
\date{2026 年 5 月}
...
\toprule
代码仓库 & \href{https://github.com/zj-yao/Homework_2}{https://github.com/zj-yao/Homework\_2}\\
模型权重 & \href{https://drive.google.com/drive/folders/1GpObjJP_6nYOdDF8HlNkBnlWKpdh7mBl?usp=sharing}{Google Drive folder}\newline
压缩包：\href{https://drive.google.com/open?id=178zInJjSr-Ue0lw0Fc0YVSLJvls1ZG4E}{homework2\_model\_weights.zip}\\
...
\begin{enumerate}
  \item GitHub 仓库已设为 public，并已在首页给出链接。
  \item 模型权重已上传到 Google Drive，并已在首页给出链接。
  \item 小组成员姓名、学号和具体分工已在首页列出。
